            ...
            <div className="FormCenter">
                ...
                <form onSubmit={this.handleSubmit} className="FormFields">
                    ...
                    <div className="FormField">
                        ...
                        <input type="text" id="mark" className="FormField__Input" placeholder="Podaj marke" name="mark" value={this.state.mark} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
                        <label className="FormField__Label" htmlFor="model">Model</label>
                        <input type="text" id="model" className="FormField__Input" placeholder="Podaj model" name="model" value={this.state.model} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
                        <label className="FormField__Label" htmlFor="ageGroup">Age Group</label>
                        <input type="number" id="ageGroup" className="FormField__Input" placeholder="Podaj rocznik" name="ageGroup" value={this.state.ageGroup} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
                        <label className="FormField__Label" htmlFor="carReviewTerm">Registration Number</label>
                        <input type="date" id="carReviewTerm" className="FormField__Input" placeholder="Podaj termin ważności przeglądu" name="carReviewTerm" value={this.state.carReviewTerm} onChange={this.handleChange} />
                    </div>
