            ...
            <div className="FormCenter">
                ...
                <form onSubmit={this.handleSubmit} className="FormFields">
                    ...
                    <div className="FormField">
                        ...
                        <input type="text" id="surname" className="FormField__Input" placeholder="Enter surname" name="surname" value={this.state.surname} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
                        <label className="FormField__Label" htmlFor="birthdayDate">BirthdayDate</label>
                        <input type="date" id="birthdayDate" className="FormField__Input" placeholder="Enter birthdayDate" name="birthdayDate" value={this.state.birthdayDate} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
                        <label className="FormField__Label" htmlFor="carLicenseTerm">CarLicenseTerm</label>
                        <input type="date" id="carLicenseTerm" className="FormField__Input" placeholder="Enter carLicenseTerm" name="carLicenseTerm" value={this.state.carLicenseTerm} onChange={this.handleChange} />
                    </div>
                    <div className="FormField">
